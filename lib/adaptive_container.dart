...
class AdaptiveContainer extends StatelessWidget {
  ...
  AdaptiveContainer({this.isParent = false,required this.children, this.physics = const ClampingScrollPhysics(), this.crossAxisAlignment = CrossAxisAlignment.start, this.mainAxisAlignment = MainAxisAlignment.start});
  ...
  // Widget childWidget(double width,Size _size) {
  //   print(width);
  //
  // }
  @override
